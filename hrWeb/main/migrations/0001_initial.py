# Generated by Django 4.0 on 2024-07-26 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periode_de', models.DateField(blank=True, null=True)),
                ('a_periode', models.DateField(blank=True, null=True)),
                ('nbre_jour_travail', models.IntegerField(blank=True, null=True)),
                ('travail_supp', models.IntegerField(blank=True, null=True)),
                ('travail_nuit', models.IntegerField(blank=True, null=True)),
                ('nbre_jour_conger', models.IntegerField(blank=True, null=True)),
                ('detail', models.TextField(blank=True)),
                ('total_prime', models.FloatField(blank=True, null=True)),
                ('total_indemnite', models.FloatField(blank=True, null=True)),
                ('total_retenue', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entreprise', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.entreprise')),
                ('salarie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.salarie')),
            ],
        ),
        migrations.AddField(
